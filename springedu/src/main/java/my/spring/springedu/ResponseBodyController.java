...
public class ResponseBodyController {
	...
	@RequestMapping(value = "/getJSON1", produces = "application/xml; charset=utf-8")
	@ResponseBody
	public String test(@PathVariable String id) {
		return "{\"result\" : \" zz1 " + id + "\"}";
	}
	
	@RequestMapping(value = "/getJSON2", produces = "application/xml; charset=utf-8")
	@ResponseBody
